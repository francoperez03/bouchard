...
export function Hero() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto flex h-full max-w-5xl flex-col items-center px-6 pt-[150px] text-center">
        ...
        >
          Robot autonomo que aprende a navegar terrenos con IA.
        </motion.p>
        ...
        >
          Un e-puck con 8 sensores, mapa en tiempo real, y Claude como
          co-piloto estrategico. Dos capas de inteligencia: reflejos
          instantaneos + planificacion con IA.
        </motion.p>
